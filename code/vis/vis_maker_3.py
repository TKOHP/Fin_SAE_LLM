...
class vis:
    ...
    def get_data(self):
        ...
        data = load_dataset("/root/data/sae/dataset/FinCorpus", split="train[:100]",cache_dir='data')
        # data = load_dataset("NeelNanda/c4-code-20k", split="train")
        print(type(data))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sae', default="/root/data/sae/sae_checkpoint/sy7irgzo/final_122880000",help="sae的checkpoint路径")
    ...
    parser.add_argument('--save_html_path', default="/root/data/sae/zyao/XuanYuan_sy7irgzo")
    parser.add_argument('--save_json_path', default="/root/data/sae/zyao/XuanYuan_sy7irgzo/config.json")
