...
if __name__ == "__main__":
    ...
    arg_parser.add_argument(
        "sae_path",
        type=str,
        default="/root/data/sae/sae_checkpoint/d4fk0vpt/final_3072000",
    ...
    arg_parser.add_argument(
        "--datasets",
        nargs="+",
        default=["/root/data/sae/dataset/FinCorpus3","/root/data/sae/dataset/FinCorpus2"],
    ...
    arg_parser.add_argument(
        "--save_path",
        type=str,
        default="/root/data/sae/evals/eval_results.csv",
    ...
    eval_results = multiple_evals(
        sae_regex_pattern=args.sae_path,
